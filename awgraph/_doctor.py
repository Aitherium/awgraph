"""Stack-aware `doctor` for awgraph.
...
interesting failures live BETWEEN them. "awgraph is installed" is not the useful
fact -- "awgraph is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awgraph'
FAMILY = ['awask', 'awavatar', 'awbac', 'awbrain', 'awbrowse', 'awclassify', 'awdecide', 'awdeck', 'awdelphi', 'awdit', 'awembed', 'awevolve', 'awfind', 'awflow', 'awfocus', 'awgit', 'awgym', 'awiam', 'awkno', 'awm', 'awmail', 'awmine', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpool', 'awpredict', 'awprism', 'awprove', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrena', 'awrepl', 'awreport', 'awresearch', 'awrise', 'awrouter', 'awrtifact', 'awrun', 'awscreen', 'awseal', 'awsettings', 'awshare', 'awsprite', 'awstorage', 'awswarm', 'awtax', 'awtoll', 'awtunnel', 'awvision', 'awvoice', 'awwall', 'gawbbonet']
PAIRS_WITH = ['adk', 'awembed', 'awm', 'awtoll']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awgraph needs at runtime, and a
